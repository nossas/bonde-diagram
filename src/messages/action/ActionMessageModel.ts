...
export interface ActionMessageModelGenerics
  extends DefaultMessageModelGenerics {
  OPTIONS: ActionMessageModelOptions;
}

class ActionMessageModel extends DefaultMessageModel<
  ActionMessageModelGenerics
> {
